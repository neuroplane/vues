create or replace function nhle.inputfieldplayers(params json, token uuid) returns json
    language plv8
as
$$
...
alter function nhle.inputfieldplayers(json, uuid) owner to neuroplane;