...
BEGIN
    ...
    _report_date = optionaldate(params, 'report_date');
...
select public.getworkingusers('{"month":5,"report_date":"2021-05-01","year":2021}'::json, '11609376-ff57-401e-88a4-53f4c0904fdb'::uuid);
